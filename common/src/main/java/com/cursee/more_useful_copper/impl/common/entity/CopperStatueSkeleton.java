...
public class CopperStatueSkeleton extends AbstractOxidizingCopperStatue implements StatueVariant {

  // private static final EntityDataAccessor<String> VARIANT = SynchedEntityData.defineId(CopperStatueSkeleton.class, EntityDataSerializers.STRING);

  private final String variant;

  public CopperStatueSkeleton(EntityType<? extends AbstractStatue> entityType, Level level) {
    super(entityType, level);
    this.variant = "skeleton";
    this.setVariant("skeleton");
  }

  @Override
  protected Item getStatueItem() {
    return ModItems.COPPER_STATUE_SKELETON;
  }

  public CopperStatueSkeleton(Level level, String variant) {
    super(ModEntities.COPPER_STATUE_SKELETON, level);
  ...
  public ResourceLocation getVariantId() {
    return MoreUsefulCopper.identifier("skeleton");
  }
}
